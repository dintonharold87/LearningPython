...
# viewing information of the first five rows in the regions of Albant and WestTexNewMexico

# print(indexed_avocado_data.loc[['Albany','WestTexNewMexico']][['Total Bags','Small Bags','Large Bags','XLarge Bags']].head())
# viewing information of the last five rows in the regions of Albant and WestTexNewMexico
# print(indexed_avocado_data.loc[['Albany','WestTexNewMexico']][['Total Bags','Small Bags','Large Bags','XLarge Bags']].tail())
# view information of the last five rows with an index of 12
# print(indexed_avocado_data.loc[["Atlanta"]][['Total Bags','Small Bags','Large Bags','XLarge Bags']].tail())
...
# print(avocado_data[((avocado_data['region']=="HartfordSpringfield")&(avocado_data['Large Bags']<100)&(avocado_data['type']=='conventional'))])
